---
title: 'The ARTnet Package for Analysis of the ARTnet Study Data'
author: "Shawnee Anderson and Samuel M. Jenness"
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{ARTnet Introduction}
...
```{r }
epistats4 <- build_epistats(geog.lvl = "division", geog.cat = "5",
                            init.hiv.prev = c(0.17, 0.17, 0.17))
epistats5 <- build_epistats(geog.lvl = "region", geog.cat = "3",
                            init.hiv.prev = c(0.17, 0.17, 0.17))
```
