...
Generated by `inst/validation/method_comparison.R` on 2026-06-08. Phase 1.5 of the joint g-comp refactor; closes part of issue #65.

ARTnet version: 2.9.0. Seed: 20260420. Network size: 5000.

## Scenarios

Derived from the scenarios actually present in the comparison object, so this table always matches the data below.

| Scenario | Description |
|---|---|
| `atlanta_default` | City config (Atlanta, race = TRUE, init.hiv.prev = c(0.33, 0.137, 0.084)) |
| `boston_default` | City config (Boston, race = TRUE, init.hiv.prev = c(0.33, 0.137, 0.084)) |
| `chicago_default` | City config (Chicago, race = TRUE, init.hiv.prev = c(0.33, 0.137, 0.084)) |
| `seattle_default` | City config (Seattle, race = TRUE, init.hiv.prev = c(0.33, 0.137, 0.084)) |
