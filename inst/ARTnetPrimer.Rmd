...
Users may always specificy `geog.lvl == "all"` in order to use the entire ARTnet dataset without geographic stratification:

```{r, echo = TRUE, eval = FALSE}
epistats4 <- build_epistats(geog.lvl = "all")
```
...
Below is the updated workflow for generating network objects for use in constructing full network:
