...
# Race
race.cat2 <- ifelse(l$race.cat %in% c("white", "other"), 1, 0)
p_race.cat2 <- ifelse(l$p_race.cat %in% c("white", "other"), 1, 0)
l$race.combo <- rep(NA, nrow(l))
l$race.combo[race.cat2 == 0 & p_race.cat2 == 0] <- 0
l$race.combo[race.cat2 == 0 & p_race.cat2 == 1] <- 1
l$race.combo[race.cat2 == 1 & p_race.cat2 == 0] <- 1
l$race.combo[race.cat2 == 1 & p_race.cat2 == 1] <- 2
table(race.cat2, p_race.cat2)
table(l$race.combo)
...
table(d$PREP_REVISED, d$PREP_CURRENT, useNA = "always")
d$prep <- ifelse(d$PREP_CURRENT == 0 | is.na(d$PREP_CURRENT), 0, 1)
